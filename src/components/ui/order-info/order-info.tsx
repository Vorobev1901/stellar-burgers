...
export const OrderInfoUI: FC<OrderInfoUIProps> = memo(({ orderInfo }) => (
  <div className={styles.wrap}>
    <p className={`${styles.number} text text_type_digits-default pt-8`}>
      #{orderInfo.number}
    </p>
    <h3 className={`text text_type_main-medium  pb-3 pt-8 ${styles.header}`}>
      {orderInfo.name}
    </h3>
    <OrderStatus status={orderInfo.status} />
    <p className={`text text_type_main-medium pt-6`}>Состав:</p>
